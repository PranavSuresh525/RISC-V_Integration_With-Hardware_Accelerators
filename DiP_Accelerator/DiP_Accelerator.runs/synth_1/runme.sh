...
HD_PWD='C:/Pranav_Folder/Verilog/DiP_Accelerator/DiP_Accelerator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dip_array.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dip_array.tcl
