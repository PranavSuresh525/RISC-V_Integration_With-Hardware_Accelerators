...
REM
REM Generated by Vivado on Sat Jun 06 12:17:40 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj dip_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj dip_tb_vlog.prj -log xvlog.log
