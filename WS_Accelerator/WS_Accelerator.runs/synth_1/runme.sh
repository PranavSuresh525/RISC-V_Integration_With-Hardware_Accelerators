...
HD_PWD='C:/Pranav_Folder/Verilog/WS_Accelerator/WS_Accelerator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ws_array.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ws_array.tcl
