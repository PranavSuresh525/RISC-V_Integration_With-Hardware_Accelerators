...
REM
REM Generated by Vivado on Sat Jun 06 11:57:17 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj ws_array_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj ws_array_tb_vlog.prj -log xvlog.log
